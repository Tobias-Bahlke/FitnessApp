    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0")
                        .description("API-Dokumentation der FitnessApp")
                ...
                .addTagsItem(new Tag().name("auth").description("Authentifizierungs-Endpunkte"))
                .addTagsItem(new Tag().name("user").description("Benutzerverwaltungs-Endpunkte"));
    }
}
